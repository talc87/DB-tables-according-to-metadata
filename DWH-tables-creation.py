...
class CreateDWHTable:
    def __init__(self,ExtractionConfig,MySQLConnectionString,MongoDBconnectionstring,MetadataDB,CollectionName):
    ...
    def GetClientMetadata(self):
        ...
        client = MongoClient(self.MongoDBconnectionstring)
        MetadataDB = client[self.MetadataDB]

        # Get the ClientMetadata collection
        ClientMetadata = MetadataDB[self.CollectionName]
    ...
    def CreateTablesObjects(self):
        ...
        DB = self.MySQLConnectionString + self.CollectionName
...
with open ('/Users/talcohen/Documents/Priority ELT/BuildDWHTables Microservice/extraction-config.json', 'r') as c:
    ExtractionConfig = json.load(c)
    
MySQLConnectionString = 'mysql+pymysql://taladmin:Nikifox2023!@erp-drv-env.mysql.database.azure.com/'
MongoDBconnectionstring = 'mongodb+srv://talcohen0507:Taltool87!@erpdataplatform.t8ot6ep.mongodb.net/?retryWrites=true&w=majority'
MetadataDB = 'MetadataDB'
CollectionName = '02721d05'



DWHDeploy = CreateDWHTable(ExtractionConfig,MySQLConnectionString,MongoDBconnectionstring,MetadataDB,CollectionName)
cDWHTables = DWHDeploy.CreateTablesObjects()